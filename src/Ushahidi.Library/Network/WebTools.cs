...
namespace Ushahidi.Library.Network
{
    ...
    public class WebTools
    {
        ...
        /// </summary>
        public IList<Incident> Uploads { get; private set; }
        ...
        public void ReportUpload(IList<Incident> incidents)
        {
        ...
        public void ReportUpload(Incident incident)
        {
            List<Incident> reports = new List<Incident>(){
                incident
            };
      ...
      public  void SearchDeployments(string search)
       ...
       public void DownloadDeployments()
        ...
        private void _ReportUpload(IList<Incident> Incidents)
        {
            Uploads = Incidents;

            int upload_count = Incidents.Count;
            foreach (Incident r in Incidents)
            {
    ...
    public class SingleUploadFinishedEventArgs : EventArgs
    {
        ...
        /// </summary>
        public Incident UploadedReport { get; set; }
        ...
        public SingleUploadFinishedEventArgs(Incident uploadedReport, UploadResponse response)
        {
